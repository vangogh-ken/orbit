	    ...
	    <tr>
		  <td colspan="2">
		    <form action="db.jsp">
			  ...
			  <label>driver:<input type="text" name="driver" value="com.mysql.jdbc.Driver"></label>
			  <label>url:<input type="text" name="url" value="jdbc:mysql://localhost:3306/van"></label>
