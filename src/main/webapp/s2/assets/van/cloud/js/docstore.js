    ...
    if(isStore) {
        ...
        _remoteCall("system/getAttachConfig.do", null, function(size) {
            ...
            $("#file_upload").uploadify({
                ...
                swf: getWebRootPath() + "/s/cloudFile/css/uploadify.swf",
                uploader :  getWebRootPath() +"/default/work/upload.do" + getJSessionCookie(),
...
function download() {
	...
	reloadPage("/work/downloadFile.do?fileName=" + $d.attr("storeFileName") + "&realName=" + $d.attr("realFileName"));
}
